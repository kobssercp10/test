...
export default function EarnPage() {
  ...
  return (
    <main className="p-4 flex flex-col gap-4">
      <div className="relative aspect-[90/31] w-full overflow-hidden rounded-lg">
        <Image src="/earn.webp" alt="Earn banner" fill className="object-cover" />
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <Input
            readOnly
            value={affiliate}
            className="w-full border-none bg-black backdrop-blur-md bg-opacity-30 rounded-lg text-white pr-10"
          />
          <Button
            size="icon"
            variant="ghost"
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center px-3 py-2 w-full border-none bg-black backdrop-blur-md bg-opacity-30 rounded-lg text-white pr-3">
